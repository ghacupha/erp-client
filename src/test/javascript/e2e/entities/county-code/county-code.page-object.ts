...
export class CountyCodeComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-county-code div table .btn-danger'));
  title = element.all(by.css('jhi-county-code div h2#page-heading span')).first();
...
export class CountyCodeUpdatePage {
  pageTitle = element(by.id('jhi-county-code-heading'));
...
export class CountyCodeDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-countyCode-heading'));
