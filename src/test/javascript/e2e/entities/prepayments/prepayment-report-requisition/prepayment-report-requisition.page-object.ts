...
export class PrepaymentReportRequisitionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-prepayment-report-requisition div table .btn-danger'));
  title = element.all(by.css('jhi-prepayment-report-requisition div h2#page-heading span')).first();
...
export class PrepaymentReportRequisitionUpdatePage {
  pageTitle = element(by.id('jhi-prepayment-report-requisition-heading'));
...
export class PrepaymentReportRequisitionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-prepaymentReportRequisition-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-prepaymentReportRequisition'));
