...
export class AmortizationPeriodComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-amortization-period div table .btn-danger'));
  title = element.all(by.css('jhi-amortization-period div h2#page-heading span')).first();
...
export class AmortizationPeriodUpdatePage {
  pageTitle = element(by.id('jhi-amortization-period-heading'));
...
export class AmortizationPeriodDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-amortizationPeriod-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-amortizationPeriod'));
