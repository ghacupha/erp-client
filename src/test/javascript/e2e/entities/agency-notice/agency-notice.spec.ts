...
import {
  AgencyNoticeComponentsPage,
  /* AgencyNoticeDeleteDialog, */
  AgencyNoticeUpdatePage,
} from './agency-notice.page-object';
...
describe('AgencyNotice e2e test', () => {
  ...
  /* it('should create and save AgencyNotices', async () => {
        ...
        await promise.all([
            ...
            agencyNoticeUpdatePage.setTaxCodeInput('taxCode'),
  ...
  /* it('should delete last AgencyNotice', async () => {
        ...
        expect(await agencyNoticeDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Agency Notice?');
