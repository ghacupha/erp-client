...
export class RouAssetListReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-rou-asset-list-report div table .btn-danger'));
  title = element.all(by.css('jhi-rou-asset-list-report div h2#page-heading span')).first();
...
export class RouAssetListReportUpdatePage {
  pageTitle = element(by.id('jhi-rou-asset-list-report-heading'));
...
export class RouAssetListReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-rouAssetListReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-rouAssetListReport'));
