...
export class LeaseLiabilityByAccountReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-lease-liability-by-account-report div table .btn-danger'));
  title = element.all(by.css('jhi-lease-liability-by-account-report div h2#page-heading span')).first();
...
export class LeaseLiabilityByAccountReportUpdatePage {
  pageTitle = element(by.id('jhi-lease-liability-by-account-report-heading'));
...
export class LeaseLiabilityByAccountReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-leaseLiabilityByAccountReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-leaseLiabilityByAccountReport'));
