...
export class LeaseLiabilityReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-lease-liability-report div table .btn-danger'));
  title = element.all(by.css('jhi-lease-liability-report div h2#page-heading span')).first();
...
export class LeaseLiabilityReportUpdatePage {
  pageTitle = element(by.id('jhi-lease-liability-report-heading'));
...
export class LeaseLiabilityReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-leaseLiabilityReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-leaseLiabilityReport'));
