...
export class LeaseLiabilityPostingReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-lease-liability-posting-report div table .btn-danger'));
  title = element.all(by.css('jhi-lease-liability-posting-report div h2#page-heading span')).first();
...
export class LeaseLiabilityPostingReportUpdatePage {
  pageTitle = element(by.id('jhi-lease-liability-posting-report-heading'));
...
export class LeaseLiabilityPostingReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-leaseLiabilityPostingReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-leaseLiabilityPostingReport'));
