...
export class LeaseLiabilityScheduleReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-lease-liability-schedule-report div table .btn-danger'));
  title = element.all(by.css('jhi-lease-liability-schedule-report div h2#page-heading span')).first();
...
export class LeaseLiabilityScheduleReportUpdatePage {
  pageTitle = element(by.id('jhi-lease-liability-schedule-report-heading'));
...
export class LeaseLiabilityScheduleReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-leaseLiabilityScheduleReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-leaseLiabilityScheduleReport'));
