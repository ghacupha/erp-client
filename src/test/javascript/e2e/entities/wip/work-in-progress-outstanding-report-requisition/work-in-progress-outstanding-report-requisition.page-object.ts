...
export class WorkInProgressOutstandingReportRequisitionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-work-in-progress-outstanding-report-requisition div table .btn-danger'));
  title = element.all(by.css('jhi-work-in-progress-outstanding-report-requisition div h2#page-heading span')).first();
...
export class WorkInProgressOutstandingReportRequisitionUpdatePage {
  pageTitle = element(by.id('jhi-work-in-progress-outstanding-report-requisition-heading'));
...
export class WorkInProgressOutstandingReportRequisitionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-workInProgressOutstandingReportRequisition-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-workInProgressOutstandingReportRequisition'));
