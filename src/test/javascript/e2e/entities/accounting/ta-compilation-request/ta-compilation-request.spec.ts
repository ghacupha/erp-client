...
describe('TACompilationRequest e2e test', () => {
  ...
  it('should create and save TACompilationRequests', async () => {
    ...
    await promise.all([
      ...
      tACompilationRequestUpdatePage.setInitialAmountStepIdentifierInput('64c99148-3908-465d-8c4a-e510e3ade974'),
      tACompilationRequestUpdatePage.setDepreciationAmountStepIdentifierInput('64c99148-3908-465d-8c4a-e510e3ade974'),
      tACompilationRequestUpdatePage.setInitialLeaseAmountStepIdentifierInput('64c99148-3908-465d-8c4a-e510e3ade974'),
      tACompilationRequestUpdatePage.setInterestAmountStepIdentifierInput('64c99148-3908-465d-8c4a-e510e3ade974'),
      tACompilationRequestUpdatePage.setFlagAmortisedStepIdentifierInput('64c99148-3908-465d-8c4a-e510e3ade974'),
