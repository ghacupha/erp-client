...
export class NbvReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-nbv-report div table .btn-danger'));
  title = element.all(by.css('jhi-nbv-report div h2#page-heading span')).first();
...
export class NbvReportUpdatePage {
  pageTitle = element(by.id('jhi-nbv-report-heading'));
...
export class NbvReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-nbvReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-nbvReport'));
