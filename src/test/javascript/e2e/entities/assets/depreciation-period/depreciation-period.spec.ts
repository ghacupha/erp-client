...
describe('DepreciationPeriod e2e test', () => {
  ...
  it('should create and save DepreciationPeriods', async () => {
    ...
    expect(await depreciationPeriodComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last DepreciationPeriod', async () => {
    ...
    expect(await depreciationPeriodDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Depreciation Period?');
