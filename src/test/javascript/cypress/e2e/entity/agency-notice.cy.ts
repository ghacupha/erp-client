...
describe('AgencyNotice e2e test', () => {
  ...
  const agencyNoticeSample = { referenceNumber: 'Ball', assessmentAmount: 37110, agencyStatus: 'NOT_CLEARED' };
  ...
  describe('AgencyNotice page', () => {
    ...
    describe('with existing value', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/agency-notices?page=0&size=20>; rel="last",<http://localhost/api/agency-notices?page=0&size=20>; rel="first"',
              },
              body: [agencyNotice],
            }
      ...
      it('edit button click should load edit AgencyNotice page and go back', () => {
      ...
      it.skip('edit button click should load edit AgencyNotice page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('AgencyNotice');
  ...
  describe('new AgencyNotice page', () => {
    ...
    it('should create an instance of AgencyNotice', () => {
      cy.get(`[data-cy="referenceNumber"]`).type('Health Soft').should('have.value', 'Health Soft');

      cy.get(`[data-cy="referenceDate"]`).type('2022-02-03').blur().should('have.value', '2022-02-03');

      cy.get(`[data-cy="assessmentAmount"]`).type('30493').should('have.value', '30493');
