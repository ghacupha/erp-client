...
describe('AssetCategory e2e test', () => {
  ...
  const assetCategorySample = { assetCategoryName: 'Gorgeous' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        depreciationMethodName: 'protocol',
        description: 'channels Sharable Chief',
  ...
  describe('AssetCategory page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit AssetCategory page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('AssetCategory');
  ...
  describe('new AssetCategory page', () => {
    ...
    it('should create an instance of AssetCategory', () => {
      cy.get(`[data-cy="assetCategoryName"]`).type('ubiquitous Mouse').should('have.value', 'ubiquitous Mouse');

      cy.get(`[data-cy="description"]`).type('Fresh Pennsylvania Salad').should('have.value', 'Fresh Pennsylvania Salad');

      cy.get(`[data-cy="notes"]`).type('Concrete Awesome').should('have.value', 'Concrete Awesome');
