...
describe('CreditNote e2e test', () => {
  ...
  const creditNoteSample = { creditNumber: 'copy', creditNoteDate: '2022-03-20', creditAmount: 70331 };
  ...
  describe('CreditNote page', () => {
    ...
    describe('with existing value', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/credit-notes?page=0&size=20>; rel="last",<http://localhost/api/credit-notes?page=0&size=20>; rel="first"',
              },
              body: [creditNote],
            }
      ...
      it('edit button click should load edit CreditNote page and go back', () => {
      ...
      it.skip('edit button click should load edit CreditNote page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('CreditNote');
  ...
  describe('new CreditNote page', () => {
    ...
    it('should create an instance of CreditNote', () => {
      cy.get(`[data-cy="creditNumber"]`).type('Creative Directives').should('have.value', 'Creative Directives');

      cy.get(`[data-cy="creditNoteDate"]`).type('2022-03-19').blur().should('have.value', '2022-03-19');

      cy.get(`[data-cy="creditAmount"]`).type('23161').should('have.value', '23161');
