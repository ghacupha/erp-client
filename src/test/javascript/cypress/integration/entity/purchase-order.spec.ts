  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        ...
        postalAddress: 'circuit Regional Cambridgeshire',
        physicalAddress: 'multi-byte networks',
        accountName: 'Savings Account',
        accountNumber: 'Fantastic mobile compress',
        bankersName: 'heuristic calculate',
        bankersBranch: 'copying',
        bankersSwiftCode: 'Human',
        fileUploadToken: 'lavender Manager',
        compilationToken: 'Borders',
      },
    }).then(({ body }) => {
      dealer = body;
    });
