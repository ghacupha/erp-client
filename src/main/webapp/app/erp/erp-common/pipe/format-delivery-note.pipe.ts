...
@Pipe({
  name: 'formatDeliveryNote',
})
export class FormatDeliveryNotePipe implements PipeTransform {

  transform(value: IDeliveryNote, args: any[]): string {
    ...
    if (value.description) {
      ...
      detail = `id: ${value.id} | #: ${value.serialNumber} | dd: ${value.documentDate} |${desc} |${value.supplier?.dealerName}`;
    }
