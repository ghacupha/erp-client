...
export class UniversallyUniqueMappingSuggestionService {
  ...
  search(searchText: string): Observable<IUniversallyUniqueMapping[]> {

    if (searchText === "") {
      return of([])
    }

    return this.http.get<IUniversallyUniqueMapping[]>(
