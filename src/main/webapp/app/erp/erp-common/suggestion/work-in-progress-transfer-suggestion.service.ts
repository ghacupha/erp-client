...
export class WorkInProgressTransferSuggestionService {
  ...
  search(searchText: string): Observable<IWorkInProgressTransfer[]> {

    if (searchText === "") {
      return of([])
    }

    return this.http.get<IWorkInProgressTransfer[]>(
