...
export class WorkInProgressRegistrationSuggestionService {
  ...
  search(searchText: string): Observable<IWorkInProgressRegistration[]> {

    if (searchText === "") {
      return of([])
    }

    return this.http.get<IWorkInProgressRegistration[]>(
