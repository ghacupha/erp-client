...
@Component({
  ...
  templateUrl: './m21-wip-registration-form-control.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => M21WipRegistrationFormControlComponent),
      multi: true
    }
  ]
})
export class M21WipRegistrationFormControlComponent implements OnInit, ControlValueAccessor, OnDestroy {

  @Input() inputValue: IWorkInProgressRegistration = {}
