...
@Component({
  selector: 'jhi-m21-wip-transfer-form-control',
  templateUrl: './m21-wip-transfer-form-control.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => M21WIPTransferFormControlComponent),
      multi: true
    }
  ]
})
export class M21WIPTransferFormControlComponent implements OnInit, ControlValueAccessor, OnDestroy {

  @Input() inputValue: IWorkInProgressTransfer = {}
