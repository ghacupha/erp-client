...
export class LeaseAmortizationCalculationSuggestionService {
  ...
  search(searchText: string): Observable<ILeaseAmortizationCalculation[]> {

    if (searchText === "") {
      return of([])
    }

    return this.http.get<ILeaseAmortizationCalculation[]>(
