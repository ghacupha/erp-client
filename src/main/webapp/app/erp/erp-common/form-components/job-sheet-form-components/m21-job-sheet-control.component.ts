...
@Component({
  selector: 'jhi-m21-job-sheet-form-control',
  templateUrl: './m21-job-sheet-form-control.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => M21JobSheetControlComponent),
      multi: true
    }
  ]
})
export class M21JobSheetControlComponent implements OnInit, ControlValueAccessor, OnDestroy {

  @Input() inputValue: IJobSheet = {}
