 ...
 */
@Component({
  selector: 'jhi-m21-lease-amortization-calculation-form-control',
  templateUrl: './m21-lease-amortization-calculation-form-control.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => M21LeaseAmortizationCalculationFormControlComponent),
      multi: true
    }
  ]
})
export class M21LeaseAmortizationCalculationFormControlComponent implements OnInit, ControlValueAccessor, OnDestroy {

  @Input() inputValue: ILeaseAmortizationCalculation = {}

  @Input() inputControlLabel = '';

  @Input() disabledInput = false;

  @Output() valueSelected: EventEmitter<ILeaseAmortizationCalculation> = new EventEmitter<ILeaseAmortizationCalculation>();
