...
import { LeasePeriodSuggestionService } from './lease-period-suggestion.service';

/**
 * Many-to-one form control component for lease-period
 */
@Component({
  selector: 'jhi-m21-lease-period-form-control',
  templateUrl: './m21-lease-period-form-control.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => M21LeasePeriodFormControlComponent),
      multi: true
    }
  ]
})
export class M21LeasePeriodFormControlComponent implements OnInit, ControlValueAccessor, OnDestroy {
  ...
  constructor(
    protected valueSuggestionService: LeasePeriodSuggestionService
  ) {}
