  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => M21PurchaseOrderFormControlComponent),
      multi: true
    }
  ]
})
export class M21PurchaseOrderFormControlComponent implements OnInit, ControlValueAccessor, OnDestroy {

  @Input() inputValue: IPurchaseOrder = {}

  @Input() inputControlLabel = '';

  @Output() valueSelected: EventEmitter<IPurchaseOrder> = new EventEmitter<IPurchaseOrder>();
