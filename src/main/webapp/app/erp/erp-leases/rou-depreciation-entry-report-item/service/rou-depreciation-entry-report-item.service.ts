...
export class RouDepreciationEntryReportItemService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/leases/rou-depreciation-entry-report-items');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/leases/_search/rou-depreciation-entry-report-items');
  ...
  query(req?: any): Observable<EntityArrayResponseType> {
    ...
    return this.http
      .get<IRouDepreciationEntryReportItem[]>(`${this.resourceUrl}/by-query`, { params: options, observe: 'response' })
