...
export interface ILeaseLiabilityPostingReport {
  id?: number;
  requestId?: string;
...
export class LeaseLiabilityPostingReport implements ILeaseLiabilityPostingReport {
  constructor(
    public id?: number,
...
export function getLeaseLiabilityPostingReportIdentifier(leaseLiabilityPostingReport: ILeaseLiabilityPostingReport): number | undefined {
  return leaseLiabilityPostingReport.id;
}
