...
import { getRouAssetListReportItemIdentifier, IRouAssetListReportItem } from '../rou-asset-list-report-item.model';
...
export class RouAssetListReportItemService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/leases/rou-asset-list-report-items');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/leases/_search/rou-asset-list-report-items');
