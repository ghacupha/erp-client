...
@Component({
  ...
  templateUrl: './rou-depreciation-posting-report-nav-parameter.component.html',
})
export class RouDepreciationPostingReportNavParameterComponent implements OnInit {
  isSaving = false;
