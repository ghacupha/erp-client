...
describe('LeasePayment Management Component', () => {
  let comp: LeasePaymentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(LeasePaymentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.leasePayments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
