...
describe('Component Tests', () => {
  describe('Prepayments Nav Component', () => {
    let comp: LeasesNavComponent;
    let fixture: ComponentFixture<LeasesNavComponent>;
    ...
    beforeEach(
      waitForAsync(() => {
        TestBed.configureTestingModule({
          ...
          declarations: [LeasesNavComponent],
          providers: [Router, LoginService],
        })
          .overrideTemplate(LeasesNavComponent, '')
          .compileComponents();
      })
    );

    beforeEach(() => {
      fixture = TestBed.createComponent(LeasesNavComponent);
