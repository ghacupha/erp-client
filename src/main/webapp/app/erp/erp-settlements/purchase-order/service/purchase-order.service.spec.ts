...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../purchase-order.test-samples';

import { PurchaseOrderService, RestPurchaseOrder } from './purchase-order.service';

const requireRestSample: RestPurchaseOrder = {
  ...sampleWithRequiredData,
  purchaseOrderDate: sampleWithRequiredData.purchaseOrderDate?.format(DATE_FORMAT),
};
