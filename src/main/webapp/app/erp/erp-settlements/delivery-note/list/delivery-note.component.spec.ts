...
describe('DeliveryNote Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'delivery-note', component: DeliveryNoteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.deliveryNotes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to deliveryNoteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDeliveryNoteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDeliveryNoteIdentifier).toHaveBeenCalledWith(entity);
