...
import { PaymentInvoiceCustomRoutingModule } from './route/payment-invoice-custom-routing.module';

@NgModule({
  imports: [SharedModule, PaymentInvoiceCustomRoutingModule, ErpCommonModule],
  declarations: [
