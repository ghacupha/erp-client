...
export class MonthlyPrepaymentOutstandingReportItemService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/prepayments/monthly-prepayment-outstanding-report-items');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/prepayments/_search/monthly-prepayment-outstanding-report-items');
