...
describe('PrepaymentMapping routing resolve service', () => {
  ...
  let resultPrepaymentMapping: IPrepaymentMapping | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IPrepaymentMapping if id is not provided', () => {
      // GIVEN
      ...
      expect(resultPrepaymentMapping).toEqual(new PrepaymentMapping());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as PrepaymentMapping })));
      mockActivatedRouteSnapshot.params = { id: 123 };
