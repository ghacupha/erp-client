...
export class AmortizationPostingReportRequisitionService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/prepayments/amortization-posting-report-requisitions');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/prepayments/_search/amortization-posting-report-requisitions');
