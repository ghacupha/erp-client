...
@Component({
  selector: 'jhi-crb-record-file-type-detail',
  templateUrl: './crb-record-file-type-detail.component.html',
})
export class CrbRecordFileTypeDetailComponent implements OnInit {
