...
@Component({
  selector: 'jhi-interbank-sector-code-detail',
  templateUrl: './interbank-sector-code-detail.component.html',
})
export class InterbankSectorCodeDetailComponent implements OnInit {
