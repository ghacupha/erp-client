...
export class MoratoriumItemUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    moratoriumItemTypeCode: [null, [Validators.required]],
    moratoriumItemType: [null, [Validators.required]],
    moratoriumTypeDetails: [],
  });
  ...
  save(): void {
    this.isSaving = true;
    const moratoriumItem = this.createFromForm();
    if (moratoriumItem.id !== undefined) {
  ...
  protected updateForm(moratoriumItem: IMoratoriumItem): void {
    this.editForm.patchValue({
      id: moratoriumItem.id,
      moratoriumItemTypeCode: moratoriumItem.moratoriumItemTypeCode,
      moratoriumItemType: moratoriumItem.moratoriumItemType,
      moratoriumTypeDetails: moratoriumItem.moratoriumTypeDetails,
    });
  }

  protected createFromForm(): IMoratoriumItem {
    return {
      ...new MoratoriumItem(),
      id: this.editForm.get(['id'])!.value,
      moratoriumItemTypeCode: this.editForm.get(['moratoriumItemTypeCode'])!.value,
      moratoriumItemType: this.editForm.get(['moratoriumItemType'])!.value,
      moratoriumTypeDetails: this.editForm.get(['moratoriumTypeDetails'])!.value,
    };
  }
}
