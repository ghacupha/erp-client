...
export class CrbCustomerTypeUpdateComponent implements OnInit {
  ...
  save(): void {
    this.isSaving = true;
    const crbCustomerType = this.createFromForm();
    if (crbCustomerType.id !== undefined) {
  ...
  protected updateForm(crbCustomerType: ICrbCustomerType): void {
    this.editForm.patchValue({
      id: crbCustomerType.id,
      customerTypeCode: crbCustomerType.customerTypeCode,
      customerType: crbCustomerType.customerType,
      description: crbCustomerType.description,
    });
  }

  protected createFromForm(): ICrbCustomerType {
    return {
      ...new CrbCustomerType(),
