...
describe('ManagementMemberType routing resolve service', () => {
  ...
  let resultManagementMemberType: IManagementMemberType | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IManagementMemberType if id is not provided', () => {
      // GIVEN
      ...
      expect(resultManagementMemberType).toEqual(new ManagementMemberType());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as ManagementMemberType })));
      mockActivatedRouteSnapshot.params = { id: 123 };
