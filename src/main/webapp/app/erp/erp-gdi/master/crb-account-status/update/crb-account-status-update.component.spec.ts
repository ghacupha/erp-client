...
describe('CrbAccountStatus Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      ...
      expect(comp.editForm.value).toEqual(expect.objectContaining(crbAccountStatus));
    });
  });
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<CrbAccountStatus>>();
      ...
      expect(crbAccountStatusService.update).toHaveBeenCalledWith(crbAccountStatus);
    ...
    it('Should call create service on save for new entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<CrbAccountStatus>>();
      const crbAccountStatus = new CrbAccountStatus();
      ...
      // THEN
      expect(crbAccountStatusService.create).toHaveBeenCalledWith(crbAccountStatus);
      expect(comp.isSaving).toEqual(false);
      expect(comp.previousState).toHaveBeenCalled();
    });
