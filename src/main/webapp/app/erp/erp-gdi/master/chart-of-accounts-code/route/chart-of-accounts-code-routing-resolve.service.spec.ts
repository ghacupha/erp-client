...
describe('ChartOfAccountsCode routing resolve service', () => {
  ...
  let resultChartOfAccountsCode: IChartOfAccountsCode | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IChartOfAccountsCode if id is not provided', () => {
      // GIVEN
      ...
      expect(resultChartOfAccountsCode).toEqual(new ChartOfAccountsCode());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as ChartOfAccountsCode })));
      mockActivatedRouteSnapshot.params = { id: 123 };
