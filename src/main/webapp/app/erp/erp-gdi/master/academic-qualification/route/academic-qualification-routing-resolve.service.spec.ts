...
describe('AcademicQualification routing resolve service', () => {
  ...
  let resultAcademicQualification: IAcademicQualification | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IAcademicQualification if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAcademicQualification).toEqual(new AcademicQualification());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AcademicQualification })));
      mockActivatedRouteSnapshot.params = { id: 123 };
