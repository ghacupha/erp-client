...
describe('GlMapping Management Component', () => {
  let comp: GlMappingComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GlMappingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.glMappings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
