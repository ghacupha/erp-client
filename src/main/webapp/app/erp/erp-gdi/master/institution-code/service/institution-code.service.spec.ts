...
describe('InstitutionCode Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      institutionOwnership: 'AAAAAAA',
      dateLicensed: currentDate,
      institutionStatus: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          dateLicensed: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
      ...
      const returnedFromService = Object.assign(
        {
          ...
          institutionOwnership: 'BBBBBB',
          dateLicensed: currentDate.format(DATE_FORMAT),
          institutionStatus: 'BBBBBB',
        },
        elemDefault
      );
    ...
    describe('addInstitutionCodeToCollectionIfMissing', () => {
      ...
      it('should add only unique InstitutionCode to an array', () => {
        const institutionCodeArray: IInstitutionCode[] = [{ id: 123 }, { id: 456 }, { id: 74030 }];
