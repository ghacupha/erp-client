...
describe('CurrencyAuthenticityFlag routing resolve service', () => {
  ...
  let resultCurrencyAuthenticityFlag: ICurrencyAuthenticityFlag | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICurrencyAuthenticityFlag if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCurrencyAuthenticityFlag).toEqual(new CurrencyAuthenticityFlag());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as CurrencyAuthenticityFlag })));
      mockActivatedRouteSnapshot.params = { id: 123 };
