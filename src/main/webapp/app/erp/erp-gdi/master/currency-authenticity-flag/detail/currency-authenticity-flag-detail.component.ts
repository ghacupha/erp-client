...
@Component({
  selector: 'jhi-currency-authenticity-flag-detail',
  templateUrl: './currency-authenticity-flag-detail.component.html',
})
export class CurrencyAuthenticityFlagDetailComponent implements OnInit {
