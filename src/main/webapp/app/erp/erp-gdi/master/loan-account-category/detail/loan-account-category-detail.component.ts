...
@Component({
  selector: 'jhi-loan-account-category-detail',
  templateUrl: './loan-account-category-detail.component.html',
})
export class LoanAccountCategoryDetailComponent implements OnInit {
