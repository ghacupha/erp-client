...
export class ContractStatusUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    contractStatusCode: [null, [Validators.required]],
    contractStatusType: [null, [Validators.required]],
    contractStatusTypeDescription: [],
  });
  ...
  protected updateForm(contractStatus: IContractStatus): void {
    this.editForm.patchValue({
      ...
      contractStatusCode: contractStatus.contractStatusCode,
      contractStatusType: contractStatus.contractStatusType,
      contractStatusTypeDescription: contractStatus.contractStatusTypeDescription,
    });
  }

  protected createFromForm(): IContractStatus {
    return {
      ...new ContractStatus(),
      id: this.editForm.get(['id'])!.value,
      contractStatusCode: this.editForm.get(['contractStatusCode'])!.value,
      contractStatusType: this.editForm.get(['contractStatusType'])!.value,
      contractStatusTypeDescription: this.editForm.get(['contractStatusTypeDescription'])!.value,
    };
  }
}
