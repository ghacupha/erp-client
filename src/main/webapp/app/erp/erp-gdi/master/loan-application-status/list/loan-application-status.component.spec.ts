...
describe('LoanApplicationStatus Management Component', () => {
  let comp: LoanApplicationStatusComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(LoanApplicationStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.loanApplicationStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
