...
@Component({
  selector: 'jhi-ultimate-beneficiary-types-detail',
  templateUrl: './ultimate-beneficiary-types-detail.component.html',
})
export class UltimateBeneficiaryTypesDetailComponent implements OnInit {
