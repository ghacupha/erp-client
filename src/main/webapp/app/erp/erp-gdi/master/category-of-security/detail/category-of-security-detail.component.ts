...
@Component({
  selector: 'jhi-category-of-security-detail',
  templateUrl: './category-of-security-detail.component.html',
})
export class CategoryOfSecurityDetailComponent implements OnInit {
