...
describe('CustomerComplaintStatusType routing resolve service', () => {
  ...
  let resultCustomerComplaintStatusType: ICustomerComplaintStatusType | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICustomerComplaintStatusType if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCustomerComplaintStatusType).toEqual(new CustomerComplaintStatusType());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as CustomerComplaintStatusType })));
      mockActivatedRouteSnapshot.params = { id: 123 };
