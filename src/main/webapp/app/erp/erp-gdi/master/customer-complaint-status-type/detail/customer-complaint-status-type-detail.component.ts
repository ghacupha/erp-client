...
@Component({
  selector: 'jhi-customer-complaint-status-type-detail',
  templateUrl: './customer-complaint-status-type-detail.component.html',
})
export class CustomerComplaintStatusTypeDetailComponent implements OnInit {
