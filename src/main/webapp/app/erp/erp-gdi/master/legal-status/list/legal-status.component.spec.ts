...
describe('LegalStatus Management Component', () => {
  let comp: LegalStatusComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(LegalStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.legalStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
