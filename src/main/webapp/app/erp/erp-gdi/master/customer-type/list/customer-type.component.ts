...
export class CustomerTypeComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.customerTypeService
        ...
        .subscribe(
          (res: HttpResponse<ICustomerType[]>) => {
  ...
  search(query: string): void {
    if (query && ['customerTypeCode', 'customerType', 'customerTypeDescription'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: ICustomerType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
