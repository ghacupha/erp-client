...
describe('CardState Management Component', () => {
  let comp: CardStateComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CardStateComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cardStates?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
