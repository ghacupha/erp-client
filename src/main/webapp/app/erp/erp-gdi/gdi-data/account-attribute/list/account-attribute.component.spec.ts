...
describe('AccountAttribute Management Component', () => {
  let comp: AccountAttributeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AccountAttributeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.accountAttributes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
