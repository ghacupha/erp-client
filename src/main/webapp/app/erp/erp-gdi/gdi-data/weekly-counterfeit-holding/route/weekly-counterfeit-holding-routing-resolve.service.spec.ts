...
describe('WeeklyCounterfeitHolding routing resolve service', () => {
  ...
  let resultWeeklyCounterfeitHolding: IWeeklyCounterfeitHolding | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IWeeklyCounterfeitHolding if id is not provided', () => {
      // GIVEN
      ...
      expect(resultWeeklyCounterfeitHolding).toEqual(new WeeklyCounterfeitHolding());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as WeeklyCounterfeitHolding })));
      mockActivatedRouteSnapshot.params = { id: 123 };
