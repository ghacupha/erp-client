...
export class ContractMetadataService {
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.startDate = res.body.startDate ? dayjs(res.body.startDate.format()) : undefined;
      res.body.terminationDate = res.body.terminationDate ? dayjs(res.body.terminationDate.format()) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((contractMetadata: IContractMetadata) => {
        contractMetadata.startDate = contractMetadata.startDate ? dayjs(contractMetadata.startDate.format()) : undefined;
        contractMetadata.terminationDate = contractMetadata.terminationDate ? dayjs(contractMetadata.terminationDate.format()) : undefined;
      });
    }
    return res;
  }
