...
export class TaxRuleComponent implements OnInit {
  ...
  trackId(index: number, item: ITaxRule): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITaxRule[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
