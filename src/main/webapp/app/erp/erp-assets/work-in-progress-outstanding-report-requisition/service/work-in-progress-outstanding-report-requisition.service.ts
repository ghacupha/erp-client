...
export class WorkInProgressOutstandingReportRequisitionService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/fixed-asset/work-in-progress-outstanding-report-requisitions');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor(
    'api/fixed-asset/_search/work-in-progress-outstanding-report-requisitions'
  );
