...
export class DepreciationMethodComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.depreciationMethodService
        ...
        .subscribe(
          (res: HttpResponse<IDepreciationMethod[]>) => {
  ...
  protected onSuccess(data: IDepreciationMethod[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    if (navigate) {
      this.router.navigate(['/depreciation-method'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
