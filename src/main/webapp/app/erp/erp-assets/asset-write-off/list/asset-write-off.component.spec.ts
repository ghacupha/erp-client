...
import { AssetWriteOffComponent } from './asset-write-off.component';

describe('AssetWriteOff Management Component', () => {
  let comp: AssetWriteOffComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AssetWriteOffComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.assetWriteOffs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
