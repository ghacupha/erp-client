...
export class DepreciationBatchSequenceService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/fixed-asset/depreciation-batch-sequences');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/fixed-asset/_search/depreciation-batch-sequences');
