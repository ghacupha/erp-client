...
import { assetRegistrationUpdateFormStateSelector } from '../reducers/asset-registration-workflow-status.reducer';

export const assetRegistrationUpdateFormState = createFeatureSelector<State>(assetRegistrationUpdateFormStateSelector);

export const assetRegistrationUpdateUpdateSelectedInstance = createSelector(
