...
describe('Component Tests', () => {
  describe('Dealer Maintenance Update Component', () => {
    let comp: DealerMaintenanceFormComponent;
    let fixture: ComponentFixture<DealerMaintenanceFormComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DealerMaintenanceFormComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(DealerMaintenanceFormComponent);
