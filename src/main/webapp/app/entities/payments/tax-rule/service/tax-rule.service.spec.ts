...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../tax-rule.test-samples';

import { TaxRuleService } from './tax-rule.service';

const requireRestSample: ITaxRule = {
...
describe('TaxRule Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a TaxRule', () => {
      ...
      const taxRule = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(taxRule).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a TaxRule', () => {
      const taxRule = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(taxRule).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addTaxRuleToCollectionIfMissing', () => {
      it('should add a TaxRule to an empty array', () => {
        const taxRule: ITaxRule = sampleWithRequiredData;
      ...
      it("should add a TaxRule to an array that doesn't contain it", () => {
        const taxRule: ITaxRule = sampleWithRequiredData;
        const taxRuleCollection: ITaxRule[] = [sampleWithPartialData];
        expectedResult = service.addTaxRuleToCollectionIfMissing(taxRuleCollection, taxRule);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(taxRule);
      });
      ...
      it('should add only unique TaxRule to an array', () => {
        const taxRuleArray: ITaxRule[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const taxRuleCollection: ITaxRule[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const taxRule: ITaxRule = sampleWithRequiredData;
        const taxRule2: ITaxRule = sampleWithPartialData;
    ...
    describe('compareTaxRule', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTaxRule(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTaxRule(entity1, entity2);
        const compareResult2 = service.compareTaxRule(entity2, entity1);
