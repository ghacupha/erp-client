...
describe('TaxRule Management Delete Component', () => {
  let comp: TaxRuleDeleteDialogComponent;
  let fixture: ComponentFixture<TaxRuleDeleteDialogComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TaxRuleDeleteDialogComponent, '')
      .compileComponents();
    fixture = TestBed.createComponent(TaxRuleDeleteDialogComponent);
