...
describe('PaymentRequisition Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'payment-requisition', component: PaymentRequisitionComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.paymentRequisitions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to paymentRequisitionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPaymentRequisitionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPaymentRequisitionIdentifier).toHaveBeenCalledWith(entity);
