...
export class PaymentCalculationComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.paymentCalculationService
        ...
        .subscribe(
          (res: HttpResponse<IPaymentCalculation[]>) => {
  ...
  trackId(index: number, item: IPaymentCalculation): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPaymentCalculation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
