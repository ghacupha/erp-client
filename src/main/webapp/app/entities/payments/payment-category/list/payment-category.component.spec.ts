...
describe('PaymentCategory Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'payment-category', component: PaymentCategoryComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to paymentCategoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPaymentCategoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPaymentCategoryIdentifier).toHaveBeenCalledWith(entity);
