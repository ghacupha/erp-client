...
import { WorkInProgressOutstandingReportComponent } from './work-in-progress-outstanding-report.component';

describe('WorkInProgressOutstandingReport Management Component', () => {
  let comp: WorkInProgressOutstandingReportComponent;
  let fixture: ComponentFixture<WorkInProgressOutstandingReportComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(WorkInProgressOutstandingReportComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(WorkInProgressOutstandingReportComponent);
