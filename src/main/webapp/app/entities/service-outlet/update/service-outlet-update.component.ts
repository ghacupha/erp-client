...
import { BankBranchCodeService } from 'app/entities/bank-branch-code/service/bank-branch-code.service';
import { IOutletType } from 'app/entities/outlet-type/outlet-type.model';
import { OutletTypeService } from 'app/entities/outlet-type/service/outlet-type.service';
import { IOutletStatus } from 'app/entities/outlet-status/outlet-status.model';
import { OutletStatusService } from 'app/entities/outlet-status/service/outlet-status.service';
import { ICountyCode } from 'app/entities/county-code/county-code.model';
import { CountyCodeService } from 'app/entities/county-code/service/county-code.service';
