...
describe('FixedAssetNetBookValue Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'fixed-asset-net-book-value', component: FixedAssetNetBookValueComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fixedAssetNetBookValues?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fixedAssetNetBookValueService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFixedAssetNetBookValueIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFixedAssetNetBookValueIdentifier).toHaveBeenCalledWith(entity);
