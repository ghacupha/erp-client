...
describe('FixedAssetDepreciation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'fixed-asset-depreciation', component: FixedAssetDepreciationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fixedAssetDepreciations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fixedAssetDepreciationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFixedAssetDepreciationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFixedAssetDepreciationIdentifier).toHaveBeenCalledWith(entity);
