...
describe('DepreciationReport Management Component', () => {
  let comp: DepreciationReportComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DepreciationReportComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.depreciationReports?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
