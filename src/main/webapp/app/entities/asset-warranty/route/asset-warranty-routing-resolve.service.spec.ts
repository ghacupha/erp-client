...
describe('AssetWarranty routing resolve service', () => {
  ...
  let resultAssetWarranty: IAssetWarranty | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAssetWarranty).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAssetWarranty>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
