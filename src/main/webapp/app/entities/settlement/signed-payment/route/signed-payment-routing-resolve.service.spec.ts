...
describe('SignedPayment routing resolve service', () => {
  ...
  let resultSignedPayment: ISignedPayment | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSignedPayment).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISignedPayment>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
