...
describe('PaymentLabel Management Delete Component', () => {
  let comp: PaymentLabelDeleteDialogComponent;
  let fixture: ComponentFixture<PaymentLabelDeleteDialogComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PaymentLabelDeleteDialogComponent, '')
      .compileComponents();
    fixture = TestBed.createComponent(PaymentLabelDeleteDialogComponent);
