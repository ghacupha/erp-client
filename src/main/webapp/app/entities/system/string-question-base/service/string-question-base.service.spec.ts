...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../string-question-base.test-samples';

import { StringQuestionBaseService } from './string-question-base.service';

const requireRestSample: IStringQuestionBase = {
...
describe('StringQuestionBase Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a StringQuestionBase', () => {
      ...
      const stringQuestionBase = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(stringQuestionBase).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a StringQuestionBase', () => {
      const stringQuestionBase = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(stringQuestionBase).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addStringQuestionBaseToCollectionIfMissing', () => {
      it('should add a StringQuestionBase to an empty array', () => {
        const stringQuestionBase: IStringQuestionBase = sampleWithRequiredData;
      ...
      it("should add a StringQuestionBase to an array that doesn't contain it", () => {
        const stringQuestionBase: IStringQuestionBase = sampleWithRequiredData;
        const stringQuestionBaseCollection: IStringQuestionBase[] = [sampleWithPartialData];
        expectedResult = service.addStringQuestionBaseToCollectionIfMissing(stringQuestionBaseCollection, stringQuestionBase);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(stringQuestionBase);
      });
      ...
      it('should add only unique StringQuestionBase to an array', () => {
        const stringQuestionBaseArray: IStringQuestionBase[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const stringQuestionBaseCollection: IStringQuestionBase[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const stringQuestionBase: IStringQuestionBase = sampleWithRequiredData;
        const stringQuestionBase2: IStringQuestionBase = sampleWithPartialData;
    ...
    describe('compareStringQuestionBase', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareStringQuestionBase(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareStringQuestionBase(entity1, entity2);
        const compareResult2 = service.compareStringQuestionBase(entity2, entity1);
