...
describe('FiscalMonth routing resolve service', () => {
  ...
  let resultFiscalMonth: IFiscalMonth | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IFiscalMonth if id is not provided', () => {
      // GIVEN
      ...
      expect(resultFiscalMonth).toEqual(new FiscalMonth());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as FiscalMonth })));
      mockActivatedRouteSnapshot.params = { id: 123 };
