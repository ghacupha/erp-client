...
export class BusinessStampComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.businessStampService
        ...
        .subscribe(
          (res: HttpResponse<IBusinessStamp[]>) => {
  ...
  protected onSuccess(data: IBusinessStamp[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    if (navigate) {
      this.router.navigate(['/business-stamp'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
