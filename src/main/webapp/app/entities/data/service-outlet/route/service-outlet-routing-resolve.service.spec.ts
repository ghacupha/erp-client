...
describe('ServiceOutlet routing resolve service', () => {
  ...
  let resultServiceOutlet: IServiceOutlet | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultServiceOutlet).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IServiceOutlet>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
