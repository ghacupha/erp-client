...
describe('SecurityClearance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'security-clearance', component: SecurityClearanceComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.securityClearances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
