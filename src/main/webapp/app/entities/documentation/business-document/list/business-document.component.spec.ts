...
describe('BusinessDocument Management Component', () => {
  let comp: BusinessDocumentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'business-document', component: BusinessDocumentComponent }]),
      ...
      .overrideTemplate(BusinessDocumentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.businessDocuments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to businessDocumentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBusinessDocumentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBusinessDocumentIdentifier).toHaveBeenCalledWith(entity);
