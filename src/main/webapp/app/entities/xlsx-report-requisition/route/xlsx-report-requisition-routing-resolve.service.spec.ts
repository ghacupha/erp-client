...
describe('XlsxReportRequisition routing resolve service', () => {
  ...
  let resultXlsxReportRequisition: IXlsxReportRequisition | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultXlsxReportRequisition).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IXlsxReportRequisition>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
