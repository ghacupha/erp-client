...
describe('PrepaymentAmortization routing resolve service', () => {
  ...
  let resultPrepaymentAmortization: IPrepaymentAmortization | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPrepaymentAmortization).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPrepaymentAmortization>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
