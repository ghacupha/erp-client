...
import {
  ...
  sampleWithFullData,
} from '../prepayment-amortization.test-samples';

import { PrepaymentAmortizationService, RestPrepaymentAmortization } from './prepayment-amortization.service';

const requireRestSample: RestPrepaymentAmortization = {
  ...sampleWithRequiredData,
  prepaymentPeriod: sampleWithRequiredData.prepaymentPeriod?.format(DATE_FORMAT),
};
...
describe('PrepaymentAmortization Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a PrepaymentAmortization', () => {
      ...
      const prepaymentAmortization = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(prepaymentAmortization).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a PrepaymentAmortization', () => {
      const prepaymentAmortization = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(prepaymentAmortization).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addPrepaymentAmortizationToCollectionIfMissing', () => {
      it('should add a PrepaymentAmortization to an empty array', () => {
        const prepaymentAmortization: IPrepaymentAmortization = sampleWithRequiredData;
      ...
      it("should add a PrepaymentAmortization to an array that doesn't contain it", () => {
        const prepaymentAmortization: IPrepaymentAmortization = sampleWithRequiredData;
        const prepaymentAmortizationCollection: IPrepaymentAmortization[] = [sampleWithPartialData];
        expectedResult = service.addPrepaymentAmortizationToCollectionIfMissing(prepaymentAmortizationCollection, prepaymentAmortization);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(prepaymentAmortization);
      });
      ...
      it('should add only unique PrepaymentAmortization to an array', () => {
        const prepaymentAmortizationArray: IPrepaymentAmortization[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const prepaymentAmortizationCollection: IPrepaymentAmortization[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const prepaymentAmortization: IPrepaymentAmortization = sampleWithRequiredData;
        const prepaymentAmortization2: IPrepaymentAmortization = sampleWithPartialData;
    ...
    describe('comparePrepaymentAmortization', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.comparePrepaymentAmortization(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.comparePrepaymentAmortization(entity1, entity2);
        const compareResult2 = service.comparePrepaymentAmortization(entity2, entity1);
