...
describe('GenderType Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ genderType: { id: 123 } }) },
        },
      ],
    })
      .overrideTemplate(GenderTypeDetailComponent, '')
      .compileComponents();
  ...
  describe('OnInit', () => {
    it('Should load genderType on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.genderType).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
