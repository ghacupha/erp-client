...
describe('GenderType Management Component', () => {
  let comp: GenderTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GenderTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.genderTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
