...
export class LoanProductTypeUpdateComponent implements OnInit {
  ...
  save(): void {
    this.isSaving = true;
    const loanProductType = this.createFromForm();
    if (loanProductType.id !== undefined) {
  ...
  protected updateForm(loanProductType: ILoanProductType): void {
    this.editForm.patchValue({
      id: loanProductType.id,
      productCode: loanProductType.productCode,
      productType: loanProductType.productType,
      productTypeDescription: loanProductType.productTypeDescription,
    });
  }

  protected createFromForm(): ILoanProductType {
    return {
      ...new LoanProductType(),
