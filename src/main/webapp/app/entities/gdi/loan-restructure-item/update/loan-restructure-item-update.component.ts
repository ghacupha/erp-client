...
export class LoanRestructureItemUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    loanRestructureItemCode: [null, [Validators.required]],
    loanRestructureItemType: [null, [Validators.required]],
    loanRestructureItemDetails: [],
  });
  ...
  save(): void {
    this.isSaving = true;
    const loanRestructureItem = this.createFromForm();
    if (loanRestructureItem.id !== undefined) {
  ...
  protected updateForm(loanRestructureItem: ILoanRestructureItem): void {
    this.editForm.patchValue({
      id: loanRestructureItem.id,
      loanRestructureItemCode: loanRestructureItem.loanRestructureItemCode,
      loanRestructureItemType: loanRestructureItem.loanRestructureItemType,
      loanRestructureItemDetails: loanRestructureItem.loanRestructureItemDetails,
    });
  }

  protected createFromForm(): ILoanRestructureItem {
    return {
      ...new LoanRestructureItem(),
      id: this.editForm.get(['id'])!.value,
      loanRestructureItemCode: this.editForm.get(['loanRestructureItemCode'])!.value,
      loanRestructureItemType: this.editForm.get(['loanRestructureItemType'])!.value,
      loanRestructureItemDetails: this.editForm.get(['loanRestructureItemDetails'])!.value,
    };
  }
}
