...
@Component({
  selector: 'jhi-counterparty-type-detail',
  templateUrl: './counterparty-type-detail.component.html',
})
export class CounterpartyTypeDetailComponent implements OnInit {
