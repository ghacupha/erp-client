...
@Component({
  selector: 'jhi-card-category-type-detail',
  templateUrl: './card-category-type-detail.component.html',
})
export class CardCategoryTypeDetailComponent implements OnInit {
