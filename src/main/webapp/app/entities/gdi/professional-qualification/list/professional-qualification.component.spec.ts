...
describe('ProfessionalQualification Management Component', () => {
  let comp: ProfessionalQualificationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProfessionalQualificationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.professionalQualifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
