...
@Component({
  selector: 'jhi-crb-report-request-reasons-detail',
  templateUrl: './crb-report-request-reasons-detail.component.html',
})
export class CrbReportRequestReasonsDetailComponent implements OnInit {
