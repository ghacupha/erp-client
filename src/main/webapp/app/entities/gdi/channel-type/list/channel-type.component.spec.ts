...
describe('ChannelType Management Component', () => {
  let comp: ChannelTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ChannelTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.channelTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
