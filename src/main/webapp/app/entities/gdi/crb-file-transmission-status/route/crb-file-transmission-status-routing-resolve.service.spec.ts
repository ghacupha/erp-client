...
describe('CrbFileTransmissionStatus routing resolve service', () => {
  ...
  let resultCrbFileTransmissionStatus: ICrbFileTransmissionStatus | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICrbFileTransmissionStatus if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCrbFileTransmissionStatus).toEqual(new CrbFileTransmissionStatus());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as CrbFileTransmissionStatus })));
      mockActivatedRouteSnapshot.params = { id: 123 };
