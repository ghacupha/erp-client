...
@Component({
  selector: 'jhi-crb-file-transmission-status-detail',
  templateUrl: './crb-file-transmission-status-detail.component.html',
})
export class CrbFileTransmissionStatusDetailComponent implements OnInit {
