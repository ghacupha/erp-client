...
describe('CrbCustomerType routing resolve service', () => {
  ...
  let resultCrbCustomerType: ICrbCustomerType | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICrbCustomerType if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCrbCustomerType).toEqual(new CrbCustomerType());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as CrbCustomerType })));
      mockActivatedRouteSnapshot.params = { id: 123 };
