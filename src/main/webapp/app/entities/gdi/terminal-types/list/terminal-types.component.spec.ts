...
describe('TerminalTypes Management Component', () => {
  let comp: TerminalTypesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TerminalTypesComponent],
      providers: [
        Router,
        {
      ...
      .overrideTemplate(TerminalTypesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.terminalTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
