...
export class CrbComplaintTypeUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    complaintTypeCode: [null, [Validators.required]],
  ...
  save(): void {
    this.isSaving = true;
    const crbComplaintType = this.createFromForm();
    if (crbComplaintType.id !== undefined) {
  ...
  protected updateForm(crbComplaintType: ICrbComplaintType): void {
    this.editForm.patchValue({
      id: crbComplaintType.id,
      complaintTypeCode: crbComplaintType.complaintTypeCode,
      complaintType: crbComplaintType.complaintType,
      complaintTypeDetails: crbComplaintType.complaintTypeDetails,
    });
  }

  protected createFromForm(): ICrbComplaintType {
    return {
      ...new CrbComplaintType(),
      id: this.editForm.get(['id'])!.value,
      complaintTypeCode: this.editForm.get(['complaintTypeCode'])!.value,
      complaintType: this.editForm.get(['complaintType'])!.value,
      complaintTypeDetails: this.editForm.get(['complaintTypeDetails'])!.value,
    };
  }
}
