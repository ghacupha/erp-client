...
export class InstitutionStatusTypeUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    institutionStatusCode: [null, [Validators.required]],
    institutionStatusType: [],
    insitutionStatusTypeDescription: [],
  });
  ...
  save(): void {
    this.isSaving = true;
    const institutionStatusType = this.createFromForm();
    if (institutionStatusType.id !== undefined) {
  ...
  protected updateForm(institutionStatusType: IInstitutionStatusType): void {
    this.editForm.patchValue({
      id: institutionStatusType.id,
      institutionStatusCode: institutionStatusType.institutionStatusCode,
      institutionStatusType: institutionStatusType.institutionStatusType,
      insitutionStatusTypeDescription: institutionStatusType.insitutionStatusTypeDescription,
    });
  }

  protected createFromForm(): IInstitutionStatusType {
    return {
      ...new InstitutionStatusType(),
      id: this.editForm.get(['id'])!.value,
      institutionStatusCode: this.editForm.get(['institutionStatusCode'])!.value,
      institutionStatusType: this.editForm.get(['institutionStatusType'])!.value,
      insitutionStatusTypeDescription: this.editForm.get(['insitutionStatusTypeDescription'])!.value,
    };
  }
}
