...
@Component({
  selector: 'jhi-fx-transaction-channel-type-detail',
  templateUrl: './fx-transaction-channel-type-detail.component.html',
})
export class FxTransactionChannelTypeDetailComponent implements OnInit {
