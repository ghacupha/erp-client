...
export class DepartmentTypeUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    departmentTypeCode: [null, [Validators.required]],
    departmentType: [null, [Validators.required]],
  ...
  save(): void {
    this.isSaving = true;
    const departmentType = this.createFromForm();
    if (departmentType.id !== undefined) {
  ...
  protected updateForm(departmentType: IDepartmentType): void {
    this.editForm.patchValue({
      ...
      departmentTypeCode: departmentType.departmentTypeCode,
      departmentType: departmentType.departmentType,
      departmentTypeDetails: departmentType.departmentTypeDetails,
      placeholders: departmentType.placeholders,
    });
  ...
  protected createFromForm(): IDepartmentType {
    return {
      ...new DepartmentType(),
      id: this.editForm.get(['id'])!.value,
      departmentTypeCode: this.editForm.get(['departmentTypeCode'])!.value,
      departmentType: this.editForm.get(['departmentType'])!.value,
      departmentTypeDetails: this.editForm.get(['departmentTypeDetails'])!.value,
