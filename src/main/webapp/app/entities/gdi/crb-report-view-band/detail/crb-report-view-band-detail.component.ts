...
@Component({
  selector: 'jhi-crb-report-view-band-detail',
  templateUrl: './crb-report-view-band-detail.component.html',
})
export class CrbReportViewBandDetailComponent implements OnInit {
