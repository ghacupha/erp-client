...
export class NatureOfCustomerComplaintsUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    natureOfComplaintTypeCode: [null, [Validators.required]],
    natureOfComplaintType: [null, [Validators.required]],
    natureOfComplaintTypeDetails: [],
  });
  ...
  save(): void {
    this.isSaving = true;
    const natureOfCustomerComplaints = this.createFromForm();
    if (natureOfCustomerComplaints.id !== undefined) {
  ...
  protected updateForm(natureOfCustomerComplaints: INatureOfCustomerComplaints): void {
    this.editForm.patchValue({
      id: natureOfCustomerComplaints.id,
      natureOfComplaintTypeCode: natureOfCustomerComplaints.natureOfComplaintTypeCode,
      natureOfComplaintType: natureOfCustomerComplaints.natureOfComplaintType,
      natureOfComplaintTypeDetails: natureOfCustomerComplaints.natureOfComplaintTypeDetails,
    });
  }

  protected createFromForm(): INatureOfCustomerComplaints {
    return {
      ...new NatureOfCustomerComplaints(),
      id: this.editForm.get(['id'])!.value,
      natureOfComplaintTypeCode: this.editForm.get(['natureOfComplaintTypeCode'])!.value,
      natureOfComplaintType: this.editForm.get(['natureOfComplaintType'])!.value,
      natureOfComplaintTypeDetails: this.editForm.get(['natureOfComplaintTypeDetails'])!.value,
    };
  }
}
