...
describe('AnticipatedMaturityPeriood routing resolve service', () => {
  ...
  let resultAnticipatedMaturityPeriood: IAnticipatedMaturityPeriood | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IAnticipatedMaturityPeriood if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAnticipatedMaturityPeriood).toEqual(new AnticipatedMaturityPeriood());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AnticipatedMaturityPeriood })));
      mockActivatedRouteSnapshot.params = { id: 123 };
