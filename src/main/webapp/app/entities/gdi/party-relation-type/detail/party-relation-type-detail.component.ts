...
@Component({
  selector: 'jhi-party-relation-type-detail',
  templateUrl: './party-relation-type-detail.component.html',
})
export class PartyRelationTypeDetailComponent implements OnInit {
