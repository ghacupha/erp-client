...
describe('InstitutionContactDetails Management Component', () => {
  let comp: InstitutionContactDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(InstitutionContactDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.institutionContactDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
