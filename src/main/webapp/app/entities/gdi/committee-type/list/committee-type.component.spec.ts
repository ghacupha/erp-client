...
describe('CommitteeType Management Component', () => {
  let comp: CommitteeTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CommitteeTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.committeeTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
