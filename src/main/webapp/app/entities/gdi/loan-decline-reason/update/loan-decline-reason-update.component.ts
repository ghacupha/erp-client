...
export class LoanDeclineReasonUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    loanDeclineReasonTypeCode: [null, [Validators.required]],
    loanDeclineReasonType: [null, [Validators.required]],
    loanDeclineReasonDetails: [],
  });
  ...
  save(): void {
    this.isSaving = true;
    const loanDeclineReason = this.createFromForm();
    if (loanDeclineReason.id !== undefined) {
  ...
  protected updateForm(loanDeclineReason: ILoanDeclineReason): void {
    this.editForm.patchValue({
      id: loanDeclineReason.id,
      loanDeclineReasonTypeCode: loanDeclineReason.loanDeclineReasonTypeCode,
      loanDeclineReasonType: loanDeclineReason.loanDeclineReasonType,
      loanDeclineReasonDetails: loanDeclineReason.loanDeclineReasonDetails,
    });
  }

  protected createFromForm(): ILoanDeclineReason {
    return {
      ...new LoanDeclineReason(),
      id: this.editForm.get(['id'])!.value,
      loanDeclineReasonTypeCode: this.editForm.get(['loanDeclineReasonTypeCode'])!.value,
      loanDeclineReasonType: this.editForm.get(['loanDeclineReasonType'])!.value,
      loanDeclineReasonDetails: this.editForm.get(['loanDeclineReasonDetails'])!.value,
    };
  }
}
