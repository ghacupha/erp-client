...
export class StaffCurrentEmploymentStatusUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    staffCurrentEmploymentStatusTypeCode: [null, [Validators.required]],
    staffCurrentEmploymentStatusType: [null, [Validators.required]],
    staffCurrentEmploymentStatusTypeDetails: [],
  });
  ...
  save(): void {
    this.isSaving = true;
    const staffCurrentEmploymentStatus = this.createFromForm();
    if (staffCurrentEmploymentStatus.id !== undefined) {
  ...
  protected updateForm(staffCurrentEmploymentStatus: IStaffCurrentEmploymentStatus): void {
    this.editForm.patchValue({
      id: staffCurrentEmploymentStatus.id,
      staffCurrentEmploymentStatusTypeCode: staffCurrentEmploymentStatus.staffCurrentEmploymentStatusTypeCode,
      staffCurrentEmploymentStatusType: staffCurrentEmploymentStatus.staffCurrentEmploymentStatusType,
      staffCurrentEmploymentStatusTypeDetails: staffCurrentEmploymentStatus.staffCurrentEmploymentStatusTypeDetails,
    });
  }

  protected createFromForm(): IStaffCurrentEmploymentStatus {
    return {
      ...new StaffCurrentEmploymentStatus(),
      id: this.editForm.get(['id'])!.value,
      staffCurrentEmploymentStatusTypeCode: this.editForm.get(['staffCurrentEmploymentStatusTypeCode'])!.value,
      staffCurrentEmploymentStatusType: this.editForm.get(['staffCurrentEmploymentStatusType'])!.value,
      staffCurrentEmploymentStatusTypeDetails: this.editForm.get(['staffCurrentEmploymentStatusTypeDetails'])!.value,
    };
  }
}
