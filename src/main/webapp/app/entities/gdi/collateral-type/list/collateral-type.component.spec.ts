...
describe('CollateralType Management Component', () => {
  let comp: CollateralTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CollateralTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.collateralTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
