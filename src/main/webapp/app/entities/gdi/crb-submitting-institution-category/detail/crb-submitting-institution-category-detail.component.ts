...
@Component({
  selector: 'jhi-crb-submitting-institution-category-detail',
  templateUrl: './crb-submitting-institution-category-detail.component.html',
})
export class CrbSubmittingInstitutionCategoryDetailComponent implements OnInit {
