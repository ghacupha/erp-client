...
@Component({
  selector: 'jhi-business-segment-types-detail',
  templateUrl: './business-segment-types-detail.component.html',
})
export class BusinessSegmentTypesDetailComponent implements OnInit {
