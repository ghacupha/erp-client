...
@Component({
  selector: 'jhi-agricultural-enterprise-activity-type-detail',
  templateUrl: './agricultural-enterprise-activity-type-detail.component.html',
})
export class AgriculturalEnterpriseActivityTypeDetailComponent implements OnInit {
