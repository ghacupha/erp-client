...
describe('LoanAccountCategory routing resolve service', () => {
  ...
  let resultLoanAccountCategory: ILoanAccountCategory | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ILoanAccountCategory if id is not provided', () => {
      // GIVEN
      ...
      expect(resultLoanAccountCategory).toEqual(new LoanAccountCategory());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as LoanAccountCategory })));
      mockActivatedRouteSnapshot.params = { id: 123 };
