...
export class AccountTypeComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['accountTypeCode', 'accountType', 'description'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IAccountType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
