...
@Component({
  selector: 'jhi-gdi-master-data-index-detail',
  templateUrl: './gdi-master-data-index-detail.component.html',
})
export class GdiMasterDataIndexDetailComponent implements OnInit {
