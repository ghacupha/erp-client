...
@Component({
  selector: 'jhi-academic-qualification-detail',
  templateUrl: './academic-qualification-detail.component.html',
})
export class AcademicQualificationDetailComponent implements OnInit {
