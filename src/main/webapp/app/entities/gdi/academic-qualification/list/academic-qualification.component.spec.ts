...
describe('AcademicQualification Management Component', () => {
  let comp: AcademicQualificationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AcademicQualificationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.academicQualifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
