...
describe('SourcesOfFundsTypeCode routing resolve service', () => {
  ...
  let resultSourcesOfFundsTypeCode: ISourcesOfFundsTypeCode | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ISourcesOfFundsTypeCode if id is not provided', () => {
      // GIVEN
      ...
      expect(resultSourcesOfFundsTypeCode).toEqual(new SourcesOfFundsTypeCode());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as SourcesOfFundsTypeCode })));
      mockActivatedRouteSnapshot.params = { id: 123 };
