...
describe('EmploymentTerms Management Component', () => {
  let comp: EmploymentTermsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EmploymentTermsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employmentTerms?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
