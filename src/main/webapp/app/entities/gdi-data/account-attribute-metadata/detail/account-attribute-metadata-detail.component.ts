...
@Component({
  selector: 'jhi-account-attribute-metadata-detail',
  templateUrl: './account-attribute-metadata-detail.component.html',
})
export class AccountAttributeMetadataDetailComponent implements OnInit {
