...
describe('QuestionBase routing resolve service', () => {
  ...
  let resultQuestionBase: IQuestionBase | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultQuestionBase).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IQuestionBase>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
