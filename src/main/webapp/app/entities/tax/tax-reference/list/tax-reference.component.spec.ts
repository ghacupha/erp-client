...
describe('TaxReference Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tax-reference', component: TaxReferenceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.taxReferences?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to taxReferenceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTaxReferenceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTaxReferenceIdentifier).toHaveBeenCalledWith(entity);
