...
describe('LeaseModelMetadata routing resolve service', () => {
  ...
  let resultLeaseModelMetadata: ILeaseModelMetadata | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLeaseModelMetadata).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILeaseModelMetadata>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
