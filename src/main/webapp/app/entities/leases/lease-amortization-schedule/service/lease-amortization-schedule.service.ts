...
export class LeaseAmortizationScheduleService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/lease-amortization-schedules');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/lease-amortization-schedules');
