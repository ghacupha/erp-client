...
export class RouAssetNBVReportItemService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/rou-asset-nbv-report-items');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/rou-asset-nbv-report-items');
  ...
  query(req?: any): Observable<EntityArrayResponseType> {
    ...
    return this.http
      .get<IRouAssetNBVReportItem[]>(this.resourceUrl, { params: options, observe: 'response' })
