...
import { IRouAssetListReport, getRouAssetListReportIdentifier } from '../rou-asset-list-report.model';
...
export class RouAssetListReportService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/rou-asset-list-reports');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/rou-asset-list-reports');
