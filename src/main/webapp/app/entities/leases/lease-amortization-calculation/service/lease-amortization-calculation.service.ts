...
export class LeaseAmortizationCalculationService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/lease-amortization-calculations');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/lease-amortization-calculations');
