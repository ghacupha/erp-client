...
export class FileTypeComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['fileTypeName', 'fileMediumType', 'description', 'fileTemplate', 'fileType'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IFileType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
